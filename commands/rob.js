...
module.exports = {
	name: 'rob',
	description: 'steals money from a user',
	args: true,
	async execute(message, args) {
		...
		if (author !== null && timeout - (Date.now() - author) > 0) {
			...
			.setColor("#FFFFFF")
			.setDescription(`<:Cross:618736602901905418> You need at least 200 cookies in your wallet to rob someone`);
			...
			.setDescription(`<:Check:618736570337591296> You robbed ${user} and got away with ${random} cookies`)
			.setColor("#FFFFFF")
